...
#from Subproblem_fixedVisitTime import Subproblem
           ...
           for k in model._activeAides:
               if Solve[k.id]==1:
                   ...
                   if value not in model._instance.list_feasible_per_aide[k.id] and new_patient:
                       ...
                       #print(list_Pik[k.id])
                       subproblem=Subproblem(model._instance,k.id,list_Pik[k.id],model._maximum_delay,model._overtime, model._alpha)
                       model._subcall+=1
                       cut=[]
...
class Master_Problem():
    ...
    def __init__(self,instance,l,overtime,alpha):
            ...
            if m.status == GRB.OPTIMAL:
                ...
                for k in self.active_aide:
                    ...
                    if Solve[k.id]==1:
                        ...
                        if new_patient:
                            subproblem=Subproblem(self.instance,k.id,f[k.id],self.maximum_delay,self.overtime,self.alpha)
                            cut=[]
    ...
    def write_solution(self,obj,nbcall,nblazy,subcall,complete_sub,inf_sub,time_limit,comp_time,sub_time):
        ...
        with open("change_deterministic.txt","a") as f:
            f.write("----------------------------------------------------------------\n")
            f.write(self.instance.instance_name+'\n')
        ...
        with open("route_deterministic.txt","a") as f:
        ...
        with open("schedule_deterministic.txt","a") as f:
        ...
        with open("Route-Schedule_deterministic.txt","a") as f:
