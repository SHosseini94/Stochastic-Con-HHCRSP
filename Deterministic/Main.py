...
def myfunc(argv):
    ...
    arg_help="{0} -d <delay> -o <overtime> -a <alpha> -di <distribution> -tc <travel_cov> -sc <service_cov -cf <coeff [rainy,clear]> -pr <prob [rainy,clear]> -cr <correlation>".format(argv[0])
    
    
    try:
        opts,args=getopt.getopt(argv[1:],"hd:o:a:di:tc:sc:cf:pr:cr:",["help","delay=","overtime=","alpha=","distribution=",
    ...
    return arg_delay,arg_overtime,arg_alpha,arg_distribution,arg_travel_cov,arg_service_cov,arg_coeff,arg_prob,arg_correlation
            ...
            for f in os.listdir():
                if f.endswith("20_20_new_data.txt"):
                    ...
                    with open(f,'r') as file:
                        ...
                        master=Master_Problem(instance,delay,overtime,alpha)
                        ...
                        if obj==0:
                            ...
                            with open(f+"_delay_{}_overtime_{}_alpha_{}_distribution_{}_correlarion_{}_TCov_{}_SCov_{}_{}_deterministic_analysis.txt".format(delay,overtime,alpha,distribution,correlation,travel_cov,service_cov,i),"w") as file:

                                    file.write("\n")
                                    file.write("Method\t"+"Deterministic \n")
