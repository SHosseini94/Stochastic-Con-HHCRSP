        ...
        for i in range(1,num_node+1):
            ...
            if i==1:
                ...
                for s in range(num_scenario):
                    ...
                    arrival[s][i-1]=visit_time[i-1]+scenario.travel_time[s][from_i*instance.number_node+to_j]
                ...
                for s in range(num_scenario):
                    ...
                    arrival[s][i-1]=start[s][i-2]+scenario.service_time[s][from_i]
                ...
                for s in range(num_scenario):
                    ...
                    arrival[s][i-1]=start[s][i-2]+scenario.service_time[s][from_i]+scenario.travel_time[s][from_i*instance.number_node+to_j]
                    start[s][i-1]=max(visit_time[i],arrival[s][i-1])
